...
Route::group([
    ...
    Route::get('sticker/sticker-styles', 'StickerCrudController@stickerStyles')->name('sticker.sticker-styles');
    Route::post('sticker/toggle-style-setting', 'StickerCrudController@toggleStyleSetting')->name('sticker.toggle-style-setting');
